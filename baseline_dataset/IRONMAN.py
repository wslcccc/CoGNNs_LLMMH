...
def inference(dataset):
    ...
    old_state_dict = torch.load('/home/wslcccc/CoGNN-DSE_1/baseline_dataset/model/IRONMAN_NEW.pth', map_location=torch.device(FLAGS.device))
...
#                    '/home/wslcccc/CoGNN-DSE_1/baseline_dataset/model/IRONMAN_NEW.pth')
#     import matplotlib
#
